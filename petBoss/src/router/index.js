...
import PeppleDetailTwo from '../components/Index/people/Peopledetailtwo.vue'
import ChangePeople from '../components/Index/people/change.vue'
import ProductDetail from '../components/Index/storage/Stock-detail.vue'
Vue.use(VueRouter)
...
const router= new VueRouter({
  routes: [
    ...
    },
    {
      ...
      children:[
        {path:'', name:'Indexhtml',component:Indexhtml},
        {path:'Peoplehtml',name:'Peoplehtml',component:Peoplehtml},
        {path:'Producthtml',name:'Producthtml',component:Producthtml},
        {path:'Performancehtml',name:'Performancehtml',component:Performancehtml},
        {path:'Analyzehtml',name:'Analyzehtml',component:Analyzehtml}
      ]
    },
    {
    ...
    {
      path:'/Peoplehtml/Administration/ChangePeople',
      name:'ChangePeople',
    ...
    {
      path:'/Producthtml/ProductDetail',
      name:'ProductDetail',
    ...
    {
      path:'/Index/Peoplehtml/Administration/PeppleDetailTwo',
      name:'PeppleDetailTwo',
      component:PeppleDetailTwo
    },
  ]
})
