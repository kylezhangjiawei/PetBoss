<template>
  <div class="header">
    ...
    <div class="header-2">
      ...
      <span class="font">开通人员账号</span>
    </div>
    <!-- 内容区域 表单格式-->
    <div class="container">
      <mt-field label="*姓名" placeholder="请输入姓名" type="text" v-model="userName" :disableClear="true"></mt-field>
      <mt-field label="*手机号" placeholder="请输入手机号" type="number" v-model="Phone" :disableClear="true"></mt-field>
      <div class="choice">
    ...
    <!-- 提交按钮 -->
    <button type="button" class="btn" @click="register()">开通</button>
    <!-- 短信提示 -->
...
//        美容师
        ...
        this.$http({
          method:'post',
          url:'https://api.yongdaoyun.com/special/pet/staff/staff_add.php',
          data:{
            "store_id":localStorage.getItem('storeId'),
            "system_id":85916832,
            "timestamp":time,
