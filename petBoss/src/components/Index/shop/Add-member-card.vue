<template>
  <div class="header">
      ...
      <div class="member-discount">
        ...
        <div v-if="modal">
          <div class="integral-double-two">
            ...
            <input type="number" class="integral-num" v-model="cardData.goods_discount">
    ...
    <!-- 修改 删除 按钮-->
    <div class="btn" @click="addCard()"><span>保存</span></div>
  </div>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      ...
      addCard(){
        console.log(this.cardData.color);
        ...
        this.$http({
          method:'post',
          url:'https://api.yongdaoyun.com/special/pet/card_item_add.php',
          data:{
            "store_id":localStorage.getItem('storeId'),
            "system_id":85916832,
            "timestamp":time,
